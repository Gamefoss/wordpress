...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		wp_register_script( 'analytics-js', get_stylesheet_directory_uri() . '/library/js/modules/analytics.min.js', array('jquery'), '', true );
		...
		wp_localize_script( 'scripts-js', 'ajax', array(
